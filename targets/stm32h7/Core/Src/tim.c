...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM6_MspInit 0 */
    ...
    /* TIM6 DMA Init */
    /* TIM6_UP Init */
    hdma_tim6_up.Instance = DMA1_Stream7;
    ...
    hdma_tim6_up.Init.FIFOMode = DMA_FIFOMODE_ENABLE;
    hdma_tim6_up.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_FULL;
    hdma_tim6_up.Init.MemBurst = DMA_MBURST_SINGLE;
    hdma_tim6_up.Init.PeriphBurst = DMA_PBURST_SINGLE;
